    ...
    while sum(hand.values()):
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                score_for_current_word = getWordScore(word, n)
                total_score += score_for_current_word
                print('"{}" earned {} points. Total: {} points'.format(word, score_for_current_word, total_score))
                # Update the hand
                hand = updateHand(hand, word)
    # Game is over (user entered a '.' or ran out of letters), so tell user the total score
    print('Total score earned per the hand:', total_score)
